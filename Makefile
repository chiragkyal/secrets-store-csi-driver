...
build-e2e-provider:
	cd test/e2eprovider && GOPROXY=$(GOPROXY) CGO_ENABLED=1 GOEXPERIMENT=strictfipsruntime GOOS=linux go build -mod=vendor -a -tags "strictfipsruntime,openssl,e2e" -o e2e-provider
